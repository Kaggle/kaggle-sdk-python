...
class ApiColumnSummaryInfo(KaggleObject):
    ...
    @column_types.setter
    def column_types(
        self, column_types: Optional[List[Optional["ApiColumnTypeSummaryInfo"]]]
    ):
        ...
        if not all([isinstance(t, ApiColumnTypeSummaryInfo) for t in column_types]):
            raise TypeError(
                "column_types must contain only items of type ApiColumnTypeSummaryInfo"
            )
...
class ApiFileSummaryInfo(KaggleObject):
    ...
    @file_types.setter
    def file_types(
        self, file_types: Optional[List[Optional["ApiFileExtensionSummaryInfo"]]]
    ):
        ...
        if not all([isinstance(t, ApiFileExtensionSummaryInfo) for t in file_types]):
            raise TypeError(
                "file_types must contain only items of type ApiFileExtensionSummaryInfo"
            )
...
ApiColumnTypeSummaryInfo._fields = [
    ...
    FieldMetadata(
        "columnCount", "column_count", "_column_count", int, 0, PredefinedSerializer()
    ),
]
...
ApiDirectory._fields = [
    ...
    FieldMetadata(
        "totalFiles", "total_files", "_total_files", int, 0, PredefinedSerializer()
    ),
    FieldMetadata(
        "totalChildren",
        "total_children",
...
ApiFileExtensionSummaryInfo._fields = [
    FieldMetadata(
        "extension", "extension", "_extension", str, "", PredefinedSerializer()
    ),
    FieldMetadata(
