...
class DatasetApiClient(object):
    ...
    def list_datasets(
        self, request: ApiListDatasetsRequest = None
    ) -> ApiListDatasetsResponse:
        r"""
        Args:
    ...
    def get_dataset(self, request: ApiGetDatasetRequest = None) -> ApiDataset:
        ...
        return self._client.call(
            "datasets.DatasetApiService", "GetDataset", request, ApiDataset
        )

    def list_dataset_files(
        self, request: ApiListDatasetFilesRequest = None
    ) -> ApiListDatasetFilesResponse:
        r"""
        Args:
    ...
    def list_tree_dataset_files(
        self, request: ApiListTreeDatasetFilesRequest = None
    ) -> ApiDirectoryContent:
        r"""
        Args:
        ...
        return self._client.call(
            "datasets.DatasetApiService",
            "ListTreeDatasetFiles",
            request,
            ApiDirectoryContent,
        )

    def get_dataset_metadata(
        self, request: ApiGetDatasetMetadataRequest = None
    ) -> ApiGetDatasetMetadataResponse:
        r"""
        Args:
    ...
    def update_dataset_metadata(
        self, request: ApiUpdateDatasetMetadataRequest = None
    ) -> ApiUpdateDatasetMetadataResponse:
        r"""
        Args:
    ...
    def download_dataset(
        self, request: ApiDownloadDatasetRequest = None
    ) -> HttpRedirect:
        r"""
        Args:
        ...
        return self._client.call(
            "datasets.DatasetApiService", "DownloadDataset", request, HttpRedirect
        )

    def download_dataset_raw(
        self, request: ApiDownloadDatasetRawRequest = None
    ) -> HttpRedirect:
        r"""
        ...
        return self._client.call(
            "datasets.DatasetApiService", "DownloadDatasetRaw", request, HttpRedirect
        )

    def create_dataset_version(
        self, request: ApiCreateDatasetVersionRequest = None
    ) -> ApiCreateDatasetResponse:
        r"""
        Args:
    ...
    def create_dataset_version_by_id(
        self, request: ApiCreateDatasetVersionByIdRequest = None
    ) -> ApiCreateDatasetResponse:
        r"""
        Args:
        ...
        return self._client.call(
            "datasets.DatasetApiService",
            "CreateDatasetVersionById",
            request,
            ApiCreateDatasetResponse,
        )

    def create_dataset(
        self, request: ApiCreateDatasetRequest = None
    ) -> ApiCreateDatasetResponse:
        r"""
        Args:
    ...
    def get_dataset_status(
        self, request: ApiGetDatasetStatusRequest = None
    ) -> ApiGetDatasetStatusResponse:
        r"""
        Args:
    ...
    def get_dataset_files_summary(
        self, request: ApiGetDatasetFilesSummaryRequest = None
    ) -> ApiFilesSummary:
        r"""
        Args:
        ...
        return self._client.call(
            "datasets.DatasetApiService",
            "GetDatasetFilesSummary",
            request,
            ApiFilesSummary,
        )

    def upload_dataset_file(
        self, request: ApiUploadDatasetFileRequest = None
    ) -> ApiUploadDatasetFileResponse:
        r"""
    ...
    def delete_dataset(
        self, request: ApiDeleteDatasetRequest = None
    ) -> ApiDeleteDatasetResponse:
        r"""
        Args:
