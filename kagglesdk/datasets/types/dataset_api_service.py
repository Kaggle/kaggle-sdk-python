...
ApiCreateDatasetVersionRequest._fields = [
    ...
    FieldMetadata(
        "datasetSlug", "dataset_slug", "_dataset_slug", str, "", PredefinedSerializer()
    ),
    FieldMetadata(
        "body",
        "body",
...
ApiDataset._fields = [
    ...
    FieldMetadata(
        "isFeatured", "is_featured", "_is_featured", bool, False, PredefinedSerializer()
    ),
    FieldMetadata(
        "licenseName",
        "license_name",
    ...
    FieldMetadata(
        "viewCount", "view_count", "_view_count", int, 0, PredefinedSerializer()
    ),
    FieldMetadata(
        "voteCount", "vote_count", "_vote_count", int, 0, PredefinedSerializer()
    ),
    FieldMetadata(
...
ApiDatasetColumn._fields = [
    FieldMetadata(
        "order", "order", "_order", int, None, PredefinedSerializer(), optional=True
    ),
    FieldMetadata(
        "name", "name", "_name", str, None, PredefinedSerializer(), optional=True
    ),
...
ApiDatasetNewFile._fields = [
    FieldMetadata(
        "token", "token", "_token", str, None, PredefinedSerializer(), optional=True
    ),
    FieldMetadata(
        "description",
        "description",
...
ApiListDatasetsRequest._fields = [
    ...
    FieldMetadata(
        ...
        "_sort_by",
        DatasetSortBy,
        DatasetSortBy.DATASET_SORT_BY_HOTTEST,
        EnumSerializer(),
    ),
    FieldMetadata(
        "size",
        ...
        "_size",
        DatasetSizeGroup,
        DatasetSizeGroup.DATASET_SIZE_GROUP_ALL,
        EnumSerializer(),
    ),
    FieldMetadata(
        "fileType",
...
ApiUpdateDatasetMetadataResponse._fields = [
    FieldMetadata(
        "errors", "errors", "_errors", str, [], ListSerializer(PredefinedSerializer())
    ),
]
