...
class SearchWithMcpRequest(KaggleObject):
  r"""
  Attributes:
    query (str)
  """
...
class SearchWithMcpResponse(KaggleObject):
  r"""
  Attributes:
    answer (str)
  """
...
SearchWithMcpRequest._fields = [
  FieldMetadata("query", "query", "_query", str, "", PredefinedSerializer()),
]

SearchWithMcpResponse._fields = [
  FieldMetadata("answer", "answer", "_answer", str, "", PredefinedSerializer()),
]
