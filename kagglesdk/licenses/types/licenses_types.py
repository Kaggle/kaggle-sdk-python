...
class License(KaggleObject):
    ...
    def agreement_status(self) -> "UserLicenseAgreementStatus":
        ...
        """
        return (
            self._agreement_status
            or UserLicenseAgreementStatus.USER_LICENSE_AGREEMENT_STATUS_UNSPECIFIED
        )

    @agreement_status.setter
    def agreement_status(
        self, agreement_status: Optional["UserLicenseAgreementStatus"]
    ):
        ...
        if not isinstance(agreement_status, UserLicenseAgreementStatus):
            raise TypeError(
                "agreement_status must be of type UserLicenseAgreementStatus"
            )
