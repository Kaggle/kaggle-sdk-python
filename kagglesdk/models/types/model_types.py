...
class ModelInstance(KaggleObject):
    ...
    def __init__(self):
        ...
        self._databundle_version_type = (
            DatabundleVersionType.DATABUNDLE_VERSION_TYPE_UNSPECIFIED
        )
        self._can_use = None
    ...
    def databundle_version_type(self, databundle_version_type: "DatabundleVersionType"):
        ...
        if not isinstance(databundle_version_type, DatabundleVersionType):
            raise TypeError(
                "databundle_version_type must be of type DatabundleVersionType"
            )
    ...
    def creation_status(
        self, creation_status: Optional[Optional["DatabundleVersionCreationStatus"]]
    ):
        ...
        if not isinstance(creation_status, DatabundleVersionCreationStatus):
            raise TypeError(
                "creation_status must be of type DatabundleVersionCreationStatus"
            )
    ...
    def download_summary(
        self, download_summary: Optional[Optional["ModelInstanceDownloadSummary"]]
    ):
        ...
        if not isinstance(download_summary, ModelInstanceDownloadSummary):
            raise TypeError(
                "download_summary must be of type ModelInstanceDownloadSummary"
            )
...
class ModelInstanceDownloadSummary(KaggleObject):
    ...
    @property
    def download_series_points(
        self,
    ) -> Optional[List[Optional["ModelActivityTimeSeriesPoint"]]]:
        return self._download_series_points

    @download_series_points.setter
    def download_series_points(
        self,
        download_series_points: Optional[
            List[Optional["ModelActivityTimeSeriesPoint"]]
        ],
    ):
        ...
        if not all(
            [
                isinstance(t, ModelActivityTimeSeriesPoint)
                for t in download_series_points
            ]
        ):
            raise TypeError(
                "download_series_points must contain only items of type ModelActivityTimeSeriesPoint"
            )
...
class ModelInstanceVersionList(KaggleObject):
    ...
    def versions(self, versions: Optional[List[Optional["ModelInstanceVersion"]]]):
        ...
        if not all([isinstance(t, ModelInstanceVersion) for t in versions]):
            raise TypeError(
                "versions must contain only items of type ModelInstanceVersion"
            )
...
ModelInstance._fields = [
    ...
    FieldMetadata(
        "databundleVersionType",
        "databundle_version_type",
        "_databundle_version_type",
        DatabundleVersionType,
        DatabundleVersionType.DATABUNDLE_VERSION_TYPE_UNSPECIFIED,
        EnumSerializer(),
    ),
    ...
    FieldMetadata(
        ...
        "creation_status",
        "_creation_status",
        DatabundleVersionCreationStatus,
        None,
        KaggleObjectSerializer(),
        optional=True,
    ),
    FieldMetadata(
        "uncompressedStorageUri",
        "uncompressed_storage_uri",
        "_uncompressed_storage_uri",
        str,
        None,
        PredefinedSerializer(),
        optional=True,
    ...
    FieldMetadata(
        "baseModelInstanceId",
        "base_model_instance_id",
        "_base_model_instance_id",
        int,
        None,
        PredefinedSerializer(),
        optional=True,
    ...
    FieldMetadata(
        "createdByKernelId",
        "created_by_kernel_id",
        "_created_by_kernel_id",
        int,
        None,
        PredefinedSerializer(),
        optional=True,
    ...
    FieldMetadata(
        "attestationKernelUrl",
        "attestation_kernel_url",
        "_attestation_kernel_url",
        str,
        None,
        PredefinedSerializer(),
        optional=True,
...
ModelInstanceDownloadSummary._fields = [
    ...
    FieldMetadata(
        "downloadSeriesPoints",
        "download_series_points",
        "_download_series_points",
...
ModelInstanceVersion._fields = [
    ...
    FieldMetadata(
        "modelTitle", "model_title", "_model_title", str, "", PredefinedSerializer()
    ),
    FieldMetadata(
        "thumbnailUrl",
        "thumbnail_url",
    ...
    FieldMetadata(
        ...
        "_sigstore_state",
        SigstoreState,
        SigstoreState.SIGSTORE_STATE_UNSPECIFIED,
        EnumSerializer(),
    ),
    FieldMetadata("modelId", "model_id", "_model_id", int, 0, PredefinedSerializer()),
    FieldMetadata(
...
Owner._fields = [
    ...
    FieldMetadata(
        "userProgressionOptOut",
        "user_progression_opt_out",
        "_user_progression_opt_out",
        bool,
        None,
        PredefinedSerializer(),
        optional=True,
