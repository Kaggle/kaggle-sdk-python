...
ModelInstanceMetric._fields = [
    FieldMetadata(
        "variation", "variation", "_variation", str, "", PredefinedSerializer()
    ),
    FieldMetadata(
        "framework",
        "framework",
    ...
    FieldMetadata(
        "downloads", "downloads", "_downloads", int, 0, PredefinedSerializer()
    ),
    FieldMetadata(
        "notebooks", "notebooks", "_notebooks", int, 0, PredefinedSerializer()
    ),
]
