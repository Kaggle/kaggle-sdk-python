...
from kagglesdk.models.types.model_enums import (
    ...
    GatingAgreementRequestsReviewStatus,
    ListModelsOrderBy,
    ModelFramework,
    ModelInstanceType,
)
from kagglesdk.models.types.model_types import (
...
class ApiCreateModelInstanceRequestBody(KaggleObject):
    ...
    def model_instance_type(self) -> "ModelInstanceType":
        return (
            self._model_instance_type
            or ModelInstanceType.MODEL_INSTANCE_TYPE_UNSPECIFIED
        )
...
class ApiGatingUserConsent(KaggleObject):
    ...
    def __init__(self):
        ...
        self._review_status = (
            GatingAgreementRequestsReviewStatus.GATING_AGREEMENT_REQUESTS_REVIEW_STATUS_UNSPECIFIED
        )
        self._expiry_status = (
            GatingAgreementRequestsExpiryStatus.GATING_AGREEMENT_REQUESTS_EXPIRY_STATUS_UNSPECIFIED
        )
    ...
    def review_status(self, review_status: "GatingAgreementRequestsReviewStatus"):
        ...
        if not isinstance(review_status, GatingAgreementRequestsReviewStatus):
            raise TypeError(
                "review_status must be of type GatingAgreementRequestsReviewStatus"
            )
    ...
    def expiry_status(self, expiry_status: "GatingAgreementRequestsExpiryStatus"):
        ...
        if not isinstance(expiry_status, GatingAgreementRequestsExpiryStatus):
            raise TypeError(
                "expiry_status must be of type GatingAgreementRequestsExpiryStatus"
            )
...
class ApiGetModelInstanceRequest(KaggleObject):
    ...
    def endpoint(self):
        path = (
            "/api/v1/models/{owner_slug}/{model_slug}/{framework}/{instance_slug}/get"
        )
        return path.format_map(self.to_field_map(self))
...
class ApiListModelGatingUserConsentsRequest(KaggleObject):
    ...
    def review_status(self) -> "GatingAgreementRequestsReviewStatus":
        ...
        return (
            self._review_status
            or GatingAgreementRequestsReviewStatus.GATING_AGREEMENT_REQUESTS_REVIEW_STATUS_UNSPECIFIED
        )

    @review_status.setter
    def review_status(
        self, review_status: Optional["GatingAgreementRequestsReviewStatus"]
    ):
        if review_status is None:
            del self.review_status
            return
    ...
    def is_user_request_data_expired(
        self, is_user_request_data_expired: Optional[bool]
    ):
...
class ApiListModelGatingUserConsentsResponse(KaggleObject):
    ...
    def gating_user_consents(
        self, gating_user_consents: Optional[List[Optional["ApiGatingUserConsent"]]]
    ):
        ...
        if not all([isinstance(t, ApiGatingUserConsent) for t in gating_user_consents]):
            raise TypeError(
                "gating_user_consents must contain only items of type ApiGatingUserConsent"
            )
...
class ApiListModelInstanceVersionFilesRequest(KaggleObject):
    ...
    def endpoint_path():
        return (
            "/api/v1/models/{owner_slug}/{model_slug}/{framework}/{instance_slug}/files"
        )
...
class ApiListModelInstanceVersionsRequest(KaggleObject):
    ...
    def endpoint(self):
        path = (
            "/api/v1/models/{owner_slug}/{model_slug}/{framework}/{instance_slug}/list"
        )
        return path.format_map(self.to_field_map(self))
...
class ApiUploadModelFileRequest(KaggleObject):
    ...
    def endpoint(self):
        path = (
            "/api/v1/models/upload/file/{content_length}/{last_modified_epoch_seconds}"
        )
        return path.format_map(self.to_field_map(self))
...
ApiCreateModelInstanceRequest._fields = [
    ...
    FieldMetadata(
        "modelSlug", "model_slug", "_model_slug", str, "", PredefinedSerializer()
    ),
    FieldMetadata(
        "body",
        "body",
...
ApiCreateModelInstanceRequestBody._fields = [
    ...
    FieldMetadata(
        ...
        "_framework",
        ModelFramework,
        ModelFramework.MODEL_FRAMEWORK_UNSPECIFIED,
        EnumSerializer(),
    ),
...
ApiGatingUserConsent._fields = [
    ...
    FieldMetadata(
        "agreementId", "agreement_id", "_agreement_id", int, 0, PredefinedSerializer()
    ),
    FieldMetadata(
...
ApiListModelGatingUserConsentsRequest._fields = [
    ...
    FieldMetadata(
        "isUserRequestDataExpired",
        "is_user_request_data_expired",
        "_is_user_request_data_expired",
        bool,
        None,
        PredefinedSerializer(),
        optional=True,
...
ApiListModelGatingUserConsentsResponse._fields = [
    FieldMetadata(
        "gatingUserConsents",
        "gating_user_consents",
        "_gating_user_consents",
        ApiGatingUserConsent,
        [],
        ListSerializer(KaggleObjectSerializer()),
    ),
    FieldMetadata(
        "totalSize", "total_size", "_total_size", int, 0, PredefinedSerializer()
    ),
    FieldMetadata(
        "nextPageToken",
        "next_page_token",
...
ApiListModelsRequest._fields = [
    ...
    FieldMetadata(
        "owner", "owner", "_owner", str, None, PredefinedSerializer(), optional=True
    ),
    FieldMetadata(
        "pageSize",
        "page_size",
...
ApiModel._fields = [
    ...
    FieldMetadata(
        "description", "description", "_description", str, "", PredefinedSerializer()
    ),
    FieldMetadata(
        "instances",
        "instances",
...
ApiModelInstance._fields = [
    ...
    FieldMetadata("usage", "usage", "_usage", str, "", PredefinedSerializer()),
    FieldMetadata(
        "downloadUrl", "download_url", "_download_url", str, "", PredefinedSerializer()
    ),
    FieldMetadata(
        "versionId", "version_id", "_version_id", int, 0, PredefinedSerializer()
    ),
    FieldMetadata(
        "versionNumber",
        "version_number",
    ...
    FieldMetadata("url", "url", "_url", str, "", PredefinedSerializer()),
    FieldMetadata(
        "licenseName", "license_name", "_license_name", str, "", PredefinedSerializer()
    ),
    FieldMetadata(
        "modelInstanceType",
        "model_instance_type",
...
KeysResponse._fields = [
    FieldMetadata(
        "keys", "keys", "_keys", JWK, [], ListSerializer(KaggleObjectSerializer())
    ),
]
