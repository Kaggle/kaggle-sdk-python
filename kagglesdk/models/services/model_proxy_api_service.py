...
from kagglesdk.models.types.model_proxy_api_service import (
    ...
    ApiCreateDefaultModelProxyTokenResponse,
)
...
class ModelProxyApiClient(object):
    ...
    def create_default_model_proxy_token(
        self, request: ApiCreateDefaultModelProxyTokenRequest = None
    ) -> ApiCreateDefaultModelProxyTokenResponse:
        r"""
        ...
        return self._client.call(
            "models.ModelProxyApiService",
            "CreateDefaultModelProxyToken",
            request,
            ApiCreateDefaultModelProxyTokenResponse,
        )
