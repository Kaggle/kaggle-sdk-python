...
class RegisterOAuthClientResponse(KaggleObject):
    ...
    def code_challenge_methods_supported(
        self, code_challenge_methods_supported: Optional[List[str]]
    ):
        ...
        if not all([isinstance(t, str) for t in code_challenge_methods_supported]):
            raise TypeError(
                "code_challenge_methods_supported must contain only items of type str"
            )
...
ExchangeOAuthTokenRequest._fields = [
    FieldMetadata(
        "code", "code", "_code", str, None, PredefinedSerializer(), optional=True
    ),
    FieldMetadata(
        "codeVerifier",
        "code_verifier",
...
ExchangeOAuthTokenResponse._fields = [
    FieldMetadata(
        "accessToken", "access_token", "_access_token", str, "", PredefinedSerializer()
    ),
    FieldMetadata(
        "refreshToken",
        "refresh_token",
    ...
    FieldMetadata(
        "tokenType", "token_type", "_token_type", str, "", PredefinedSerializer()
    ),
    FieldMetadata(
    ...
    FieldMetadata(
        "scope", "scope", "_scope", str, None, PredefinedSerializer(), optional=True
    ),
]
...
IntrospectTokenResponse._fields = [
    ...
    FieldMetadata(
        "clientId", "client_id", "_client_id", str, "", PredefinedSerializer()
    ),
    FieldMetadata("username", "username", "_username", str, "", PredefinedSerializer()),
    FieldMetadata(
        "userId",
    ...
    FieldMetadata(
        "exp", "exp", "_exp", int, None, PredefinedSerializer(), optional=True
    ),
]

RegisterOAuthClientRequest._fields = [
    FieldMetadata(
        "clientName", "client_name", "_client_name", str, "", PredefinedSerializer()
    ),
    FieldMetadata(
        "redirectUris",
        "redirect_uris",
...
RegisterOAuthClientResponse._fields = [
    FieldMetadata(
        "client_id", "client_id", "_client_id", str, "", PredefinedSerializer()
    ),
    FieldMetadata(
        "redirect_uris",
        "redirect_uris",
...
StartOAuthFlowRequest._fields = [
    ...
    FieldMetadata(
        "redirectUri", "redirect_uri", "_redirect_uri", str, "", PredefinedSerializer()
    ),
    FieldMetadata("scope", "scope", "_scope", str, "", PredefinedSerializer()),
