...
GroupPrincipal._fields = [
    ...
    FieldMetadata(
        "avatar", "avatar", "_avatar", UserManagedGroup, None, KaggleObjectSerializer()
    ),
]
...
IamPolicy._fields = [
    ...
    FieldMetadata(
        "owner", "owner", "_owner", Principal, None, KaggleObjectSerializer()
    ),
]
...
IamPolicyBinding._fields = [
    FieldMetadata(
        ...
        "_role",
        CanonicalRole,
        CanonicalRole.CANONICAL_ROLE_UNSPECIFIED,
        EnumSerializer(),
    ),
    FieldMetadata(
        "members",
...
OrganizationPrincipal._fields = [
    ...
    FieldMetadata(
        "avatar", "avatar", "_avatar", Organization, None, KaggleObjectSerializer()
    ),
]
...
Principal._fields = [
    ...
    FieldMetadata(
        "isFixed", "is_fixed", "_is_fixed", bool, False, PredefinedSerializer()
    ),
]
...
SetIamPolicyRequest._fields = [
    ...
    FieldMetadata(
        "policy", "policy", "_policy", IamPolicy, None, KaggleObjectSerializer()
    ),
]
