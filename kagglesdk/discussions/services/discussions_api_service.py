...
class DiscussionApiClient(object):
    ...
    def list_forums(
        self, request: ApiListForumsRequest = None
    ) -> ApiListForumsResponse:
        r"""
        ...
        return self._client.call(
            "discussions.DiscussionApiService",
            "ListForums",
            request,
            ApiListForumsResponse,
        )
    ...
    def list_topics(
        self, request: ApiListTopicsRequest = None
    ) -> ApiListTopicsResponse:
        r"""
    ...
    def get_topic(self, request: ApiGetTopicRequest = None) -> ApiGetTopicResponse:
        ...
        return self._client.call(
            "discussions.DiscussionApiService", "GetTopic", request, ApiGetTopicResponse
        )

    def list_comments(
        self, request: ApiListCommentsRequest = None
    ) -> ApiListCommentsResponse:
        r"""
    ...
    def list_dataset_topics(
        self, request: ApiListDatasetTopicsRequest = None
    ) -> ApiListTopicsResponse:
        r"""
    ...
    def list_model_topics(
        self, request: ApiListModelTopicsRequest = None
    ) -> ApiListTopicsResponse:
        r"""
    ...
    def list_benchmark_topics(
        self, request: ApiListBenchmarkTopicsRequest = None
    ) -> ApiListTopicsResponse:
        r"""
    ...
    def list_kernel_topics(
        self, request: ApiListKernelTopicsRequest = None
    ) -> ApiListTopicsResponse:
        r"""
