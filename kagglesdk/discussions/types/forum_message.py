...
class CommentForumMessage(KaggleObject):
    ...
    def __init__(self):
        ...
        self._moderation_status = (
            PrivatedModerationStatus.PRIVATED_MODERATION_STATUS_UNSPECIFIED
        )
    ...
    def replies(self, replies: Optional[List[Optional["CommentForumMessage"]]]):
        ...
        if not all([isinstance(t, CommentForumMessage) for t in replies]):
            raise TypeError(
                "replies must contain only items of type CommentForumMessage"
            )
    ...
    def attachments(self, attachments: Optional[List[Optional["CommentAttachment"]]]):
        ...
        if not all([isinstance(t, CommentAttachment) for t in attachments]):
            raise TypeError(
                "attachments must contain only items of type CommentAttachment"
            )
    ...
    def feedback_tracking_data(
        self, feedback_tracking_data: Optional["FeedbackTrackingData"]
    ):
        ...
        if not isinstance(feedback_tracking_data, FeedbackTrackingData):
            raise TypeError(
                "feedback_tracking_data must be of type FeedbackTrackingData"
            )
    ...
    def moderation_status(self, moderation_status: "PrivatedModerationStatus"):
        ...
        if not isinstance(moderation_status, PrivatedModerationStatus):
            raise TypeError(
                "moderation_status must be of type PrivatedModerationStatus"
            )
    ...
    @reactions.setter
    def reactions(
        self, reactions: Optional[List[Optional["ForumMessageReactionGroup"]]]
    ):
        ...
        if not all([isinstance(t, ForumMessageReactionGroup) for t in reactions]):
            raise TypeError(
                "reactions must contain only items of type ForumMessageReactionGroup"
            )
...
CommentForumMessage._fields = [
    ...
    FieldMetadata(
        "author", "author", "_author", UserAvatar, None, KaggleObjectSerializer()
    ),
    FieldMetadata(
        "authorType",
        "author_type",
        "_author_type",
        CommentAuthorType,
        CommentAuthorType.COMMENT_AUTHOR_TYPE_UNSPECIFIED,
        EnumSerializer(),
    ),
    FieldMetadata(
        "votes", "votes", "_votes", CommentVoteButton, None, KaggleObjectSerializer()
    ),
    FieldMetadata(
        "canDelete", "can_delete", "_can_delete", bool, False, PredefinedSerializer()
    ),
    FieldMetadata(
        "isUserAuthor",
        "is_user_author",
    ...
    FieldMetadata(
        "hasFlags", "has_flags", "_has_flags", bool, False, PredefinedSerializer()
    ),
    FieldMetadata(
    ...
    FieldMetadata(
        "isFlagged", "is_flagged", "_is_flagged", bool, False, PredefinedSerializer()
    ),
    FieldMetadata(
        "isSpammed", "is_spammed", "_is_spammed", bool, False, PredefinedSerializer()
    ),
    FieldMetadata(
        "currentKernelVersion",
        "current_kernel_version",
        "_current_kernel_version",
        int,
        0,
        PredefinedSerializer(),
    ),
    ...
    FieldMetadata(
        "isPartial", "is_partial", "_is_partial", bool, False, PredefinedSerializer()
    ),
    FieldMetadata(
        "reactions",
        "reactions",
        "_reactions",
        ForumMessageReactionGroup,
        [],
        ListSerializer(KaggleObjectSerializer()),
    ),
    FieldMetadata(
...
CommentVoteButton._fields = [
    FieldMetadata(
        "totalVotes", "total_votes", "_total_votes", int, 0, PredefinedSerializer()
    ),
    FieldMetadata(
        "hasAlreadyVotedUp",
        "has_already_voted_up",
        "_has_already_voted_up",
        bool,
        False,
        PredefinedSerializer(),
    ),
    FieldMetadata(
        "hasAlreadyVotedDown",
        "has_already_voted_down",
        "_has_already_voted_down",
        bool,
        False,
        PredefinedSerializer(),
    ),
    FieldMetadata(
        "canUpvote", "can_upvote", "_can_upvote", bool, False, PredefinedSerializer()
    ),
    FieldMetadata(
        "canDownvote",
        "can_downvote",
...
ForumMessageReactionGroup._fields = [
    FieldMetadata(
        ...
        "_emoji",
        EmojiReaction,
        EmojiReaction.EMOJI_REACTION_UNSPECIFIED,
        EnumSerializer(),
    ),
    FieldMetadata(
        "featuredUserNames",
        "featured_user_names",
        "_featured_user_names",
        str,
        [],
        ListSerializer(PredefinedSerializer()),
    ),
    FieldMetadata(
        "userCount", "user_count", "_user_count", int, 0, PredefinedSerializer()
    ),
]
