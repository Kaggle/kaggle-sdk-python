...
class ForumMessage(KaggleObject):
  r"""
  Attributes:
    id (int)
    post_date (datetime)
    post_user_id (int)
    post_user_thumbnail_name (str)
    post_username (str)
    post_user_display_name (str)
    topic_name (str)
    topic_url (str)
    script_id (int)
    forum_name (str)
    ...
    message_url (str)
    score (int)
    is_first_message_in_topic (bool)
    is_spam (bool)
    is_deleted (bool)
    is_pinned (bool)
    topic_id (int)
    ...
    is_private (bool)
    total_replies (int)
    post_user_performance_tier (UserAchievementTier)
    is_write_up_message (bool)
    post_user_progression_opt_out (bool)
  """

  def __init__(self):
    self._id = 0
    self._post_date = None
    self._post_user_id = None
    self._post_user_thumbnail_name = None
    self._post_username = None
    self._post_user_display_name = None
    ...
    self._message_url = ""
    self._score = 0
    self._is_first_message_in_topic = False
    self._is_spam = False
    self._is_deleted = False
    self._is_pinned = False
    self._topic_id = 0
    ...
    self._post_user_performance_tier = UserAchievementTier.NOVICE
    self._is_write_up_message = False
    self._post_user_progression_opt_out = None
    self._freeze()
  ...
  @property
  def post_user_id(self) -> int:
    return self._post_user_id or 0

  @post_user_id.setter
  def post_user_id(self, post_user_id: Optional[int]):
    if post_user_id is None:
      del self.post_user_id
      return
    if not isinstance(post_user_id, int):
      raise TypeError('post_user_id must be of type int')
    self._post_user_id = post_user_id

  @property
  def post_user_thumbnail_name(self) -> str:
    return self._post_user_thumbnail_name or ""

  @post_user_thumbnail_name.setter
  def post_user_thumbnail_name(self, post_user_thumbnail_name: Optional[str]):
    if post_user_thumbnail_name is None:
      del self.post_user_thumbnail_name
      return
    if not isinstance(post_user_thumbnail_name, str):
      raise TypeError('post_user_thumbnail_name must be of type str')
    self._post_user_thumbnail_name = post_user_thumbnail_name

  @property
  def post_username(self) -> str:
    return self._post_username or ""

  @post_username.setter
  def post_username(self, post_username: Optional[str]):
    if post_username is None:
      del self.post_username
      return
    if not isinstance(post_username, str):
      raise TypeError('post_username must be of type str')
    self._post_username = post_username

  @property
  def post_user_display_name(self) -> str:
    return self._post_user_display_name or ""

  @post_user_display_name.setter
  def post_user_display_name(self, post_user_display_name: Optional[str]):
    if post_user_display_name is None:
      del self.post_user_display_name
      return
    if not isinstance(post_user_display_name, str):
      raise TypeError('post_user_display_name must be of type str')
    self._post_user_display_name = post_user_display_name

  @property
  def post_user_performance_tier(self) -> 'UserAchievementTier':
    return self._post_user_performance_tier

  @post_user_performance_tier.setter
  def post_user_performance_tier(self, post_user_performance_tier: 'UserAchievementTier'):
    if post_user_performance_tier is None:
      del self.post_user_performance_tier
      return
    if not isinstance(post_user_performance_tier, UserAchievementTier):
      raise TypeError('post_user_performance_tier must be of type UserAchievementTier')
    self._post_user_performance_tier = post_user_performance_tier

  @property
  def post_user_progression_opt_out(self) -> bool:
    return self._post_user_progression_opt_out or False

  @post_user_progression_opt_out.setter
  def post_user_progression_opt_out(self, post_user_progression_opt_out: Optional[bool]):
    if post_user_progression_opt_out is None:
      del self.post_user_progression_opt_out
      return
    if not isinstance(post_user_progression_opt_out, bool):
      raise TypeError('post_user_progression_opt_out must be of type bool')
    self._post_user_progression_opt_out = post_user_progression_opt_out

  @property
  def topic_name(self) -> str:
    return self._topic_name or ""

  @topic_name.setter
  def topic_name(self, topic_name: Optional[str]):
  ...
  def script_id(self) -> int:
    return self._script_id or 0

  @script_id.setter
  def script_id(self, script_id: Optional[int]):
  ...
  @forum_name.setter
  def forum_name(self, forum_name: Optional[str]):
  ...
  @property
  def is_first_message_in_topic(self) -> bool:
    return self._is_first_message_in_topic

  @is_first_message_in_topic.setter
  def is_first_message_in_topic(self, is_first_message_in_topic: bool):
    if is_first_message_in_topic is None:
      del self.is_first_message_in_topic
      return
    if not isinstance(is_first_message_in_topic, bool):
      raise TypeError('is_first_message_in_topic must be of type bool')
    self._is_first_message_in_topic = is_first_message_in_topic
  ...
  @is_spam.setter
  def is_spam(self, is_spam: bool):
    if is_spam is None:
      del self.is_spam
      return
    if not isinstance(is_spam, bool):
      raise TypeError('is_spam must be of type bool')
  ...
  @property
  def is_write_up_message(self) -> bool:
    return self._is_write_up_message

  @is_write_up_message.setter
  def is_write_up_message(self, is_write_up_message: bool):
    if is_write_up_message is None:
      del self.is_write_up_message
      return
    if not isinstance(is_write_up_message, bool):
      raise TypeError('is_write_up_message must be of type bool')
    self._is_write_up_message = is_write_up_message
...
ForumMessage._fields = [
  FieldMetadata("id", "id", "_id", int, 0, PredefinedSerializer()),
  FieldMetadata("postDate", "post_date", "_post_date", datetime, None, DateTimeSerializer()),
  FieldMetadata("postUserId", "post_user_id", "_post_user_id", int, None, PredefinedSerializer(), optional=True),
  FieldMetadata("postUserThumbnailName", "post_user_thumbnail_name", "_post_user_thumbnail_name", str, None, PredefinedSerializer(), optional=True),
  FieldMetadata("postUsername", "post_username", "_post_username", str, None, PredefinedSerializer(), optional=True),
  FieldMetadata("postUserDisplayName", "post_user_display_name", "_post_user_display_name", str, None, PredefinedSerializer(), optional=True),
  FieldMetadata("topicName", "topic_name", "_topic_name", str, None, PredefinedSerializer(), optional=True),
  FieldMetadata("topicUrl", "topic_url", "_topic_url", str, "", PredefinedSerializer()),
  FieldMetadata("scriptId", "script_id", "_script_id", int, None, PredefinedSerializer(), optional=True),
  ...
  FieldMetadata("isFirstMessageInTopic", "is_first_message_in_topic", "_is_first_message_in_topic", bool, False, PredefinedSerializer()),
  FieldMetadata("isSpam", "is_spam", "_is_spam", bool, False, PredefinedSerializer()),
  FieldMetadata("isDeleted", "is_deleted", "_is_deleted", bool, False, PredefinedSerializer()),
  FieldMetadata("isPinned", "is_pinned", "_is_pinned", bool, False, PredefinedSerializer()),
  ...
  FieldMetadata("postUserPerformanceTier", "post_user_performance_tier", "_post_user_performance_tier", UserAchievementTier, UserAchievementTier.NOVICE, EnumSerializer()),
  FieldMetadata("isWriteUpMessage", "is_write_up_message", "_is_write_up_message", bool, False, PredefinedSerializer()),
  FieldMetadata("postUserProgressionOptOut", "post_user_progression_opt_out", "_post_user_progression_opt_out", bool, None, PredefinedSerializer(), optional=True),
]
