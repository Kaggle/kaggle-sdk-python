...
from kagglesdk.discussions.types.writeup_enums import (
    ResolvedWriteUpLinkType,
    WriteUpLinkLocation,
    WriteUpLinkMediaType,
    WriteUpType,
)
...
class WriteUp(KaggleObject):
    ...
    def write_up_links(self, write_up_links: Optional[List[Optional["WriteUpLink"]]]):
        ...
        if not all([isinstance(t, WriteUpLink) for t in write_up_links]):
            raise TypeError(
                "write_up_links must contain only items of type WriteUpLink"
            )
...
ResolvedWriteUpLink._fields = [
    ...
    FieldMetadata(
        ...
        "_type",
        ResolvedWriteUpLinkType,
        ResolvedWriteUpLinkType.RESOLVED_WRITE_UP_LINK_TYPE_UNSPECIFIED,
        EnumSerializer(),
    ),
    FieldMetadata(
    ...
    FieldMetadata(
        "originalUrl", "original_url", "_original_url", str, "", PredefinedSerializer()
    ),
]
...
WriteUp._fields = [
    ...
    FieldMetadata(
        ...
        "_type",
        WriteUpType,
        WriteUpType.WRITE_UP_TYPE_UNSPECIFIED,
        EnumSerializer(),
    ),
    FieldMetadata(
        "coverImageUrl",
    ...
    FieldMetadata(
        "tags", "tags", "_tags", Tag, [], ListSerializer(KaggleObjectSerializer())
    ),
    ...
    FieldMetadata(
        "canEdit", "can_edit", "_can_edit", bool, False, PredefinedSerializer()
    ),
    FieldMetadata(
    ...
    FieldMetadata(
        ...
        "_content_state",
        ContentState,
        ContentState.CONTENT_STATE_UNSPECIFIED,
        EnumSerializer(),
    ),
    FieldMetadata(
    ...
    FieldMetadata(
        "savedCoverImageUrl",
        "saved_cover_image_url",
        "_saved_cover_image_url",
        str,
        "",
        PredefinedSerializer(),
    ),
    FieldMetadata(
        ...
        "saved_thumbnail_image_url",
        "_saved_thumbnail_image_url",
        str,
        "",
        PredefinedSerializer(),
    ),
    FieldMetadata(
        "doi", "doi", "_doi", str, None, PredefinedSerializer(), optional=True
    ),
]
...
WriteUpLink._fields = [
    ...
    FieldMetadata("title", "title", "_title", str, "", PredefinedSerializer()),
    FieldMetadata(
        "sortKey", "sort_key", "_sort_key", float, 0.0, PredefinedSerializer()
    ),
    FieldMetadata(
        "location",
        "location",
        "_location",
        WriteUpLinkLocation,
        WriteUpLinkLocation.WRITE_UP_LINK_LOCATION_UNSPECIFIED,
        EnumSerializer(),
    ),
    FieldMetadata(
    ...
    FieldMetadata(
        "image", "image", "_image", CroppedImageUpload, None, KaggleObjectSerializer()
    ),
    FieldMetadata(
        "mediaType",
        "media_type",
        "_media_type",
        WriteUpLinkMediaType,
        WriteUpLinkMediaType.WRITE_UP_LINK_MEDIA_TYPE_UNSPECIFIED,
        EnumSerializer(),
    ),
    FieldMetadata(
        "resource",
    ...
    FieldMetadata(
        "externalThumbnailImageUrl",
        "external_thumbnail_image_url",
        "_external_thumbnail_image_url",
        str,
        None,
        PredefinedSerializer(),
        optional=True,
