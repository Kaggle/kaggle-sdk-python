...
class WriteUpLinkMetadata(KaggleObject):
  r"""
  Attributes:
    title (str)
    url (str)
  ...
  def __init__(self):
    ...
    self._model_id = None
    self._description = ""
    self._external_thumbnail_image_url = ""
    self._resource = None
    self._benchmark_id = None
    self._freeze()
  ...
  @property
  def external_thumbnail_image_url(self) -> str:
    return self._external_thumbnail_image_url

  @external_thumbnail_image_url.setter
  def external_thumbnail_image_url(self, external_thumbnail_image_url: str):
    if external_thumbnail_image_url is None:
      del self.external_thumbnail_image_url
      return
    if not isinstance(external_thumbnail_image_url, str):
  ...
  @property
  def resource(self) -> Optional['WriteUpLinkResource']:
    return self._resource or None

  @resource.setter
  def resource(self, resource: Optional[Optional['WriteUpLinkResource']]):
    if resource is None:
      del self.resource
      return
    if not isinstance(resource, WriteUpLinkResource):
...
WriteUpLinkMetadata._fields = [
  ...
  FieldMetadata("externalThumbnailImageUrl", "external_thumbnail_image_url", "_external_thumbnail_image_url", str, "", PredefinedSerializer()),
  FieldMetadata("resource", "resource", "_resource", WriteUpLinkResource, None, KaggleObjectSerializer(), optional=True),
  FieldMetadata("benchmarkId", "benchmark_id", "_benchmark_id", int, None, PredefinedSerializer(), optional=True),
]
