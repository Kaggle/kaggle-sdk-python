...
class AgentExamSubmissionSummary(KaggleObject):
    ...
    def __init__(self):
        self._submission_id = ""
        self._status = (
            AgentExamSubmissionStatus.AGENT_EXAM_SUBMISSION_STATUS_UNSPECIFIED
        )
        self._score = None
...
class ApiCreateAgentExamSubmissionResponse(KaggleObject):
    ...
    def questions(self, questions: Optional[List[Optional["AgentExamQuestion"]]]):
        ...
        if not all([isinstance(t, AgentExamQuestion) for t in questions]):
            raise TypeError(
                "questions must contain only items of type AgentExamQuestion"
            )
...
class ApiGetAgentExamAgentResponse(KaggleObject):
    ...
    @submissions.setter
    def submissions(
        self, submissions: Optional[List[Optional["AgentExamSubmissionSummary"]]]
    ):
        ...
        if not all([isinstance(t, AgentExamSubmissionSummary) for t in submissions]):
            raise TypeError(
                "submissions must contain only items of type AgentExamSubmissionSummary"
            )
...
class ApiGetAgentExamInsightsResponse(KaggleObject):
    ...
    def score_distribution(
        self, score_distribution: Optional[List[Optional["ScoreDistributionBin"]]]
    ):
        ...
        if not all([isinstance(t, ScoreDistributionBin) for t in score_distribution]):
            raise TypeError(
                "score_distribution must contain only items of type ScoreDistributionBin"
            )
...
class ApiListTopAgentExamAgentsResponse(KaggleObject):
    ...
    def agents(self, agents: Optional[List[Optional["AgentExamAgentScore"]]]):
        ...
        if not all([isinstance(t, AgentExamAgentScore) for t in agents]):
            raise TypeError(
                "agents must contain only items of type AgentExamAgentScore"
            )
        self._agents = agents
...
AgentExamAgentScore._fields = [
    ...
    FieldMetadata(
        "agentName", "agent_name", "_agent_name", str, "", PredefinedSerializer()
    ),
    FieldMetadata("model", "model", "_model", str, "", PredefinedSerializer()),
    FieldMetadata(
        "bestScore", "best_score", "_best_score", int, 0, PredefinedSerializer()
    ),
    FieldMetadata(
        "totalExams", "total_exams", "_total_exams", int, 0, PredefinedSerializer()
    ),
    FieldMetadata(
        "agentType",
        "agent_type",
...
AgentExamSubmissionSummary._fields = [
    ...
    FieldMetadata(
        "score", "score", "_score", int, None, PredefinedSerializer(), optional=True
    ),
    FieldMetadata(
        "maxScore",
        "max_score",
    ...
    FieldMetadata(
        "passed", "passed", "_passed", bool, None, PredefinedSerializer(), optional=True
    ),
    FieldMetadata(
...
ApiCompleteAgentExamSubmissionRequest._fields = [
    ...
    FieldMetadata(
        "answers", "answers", "_answers", str, {}, MapSerializer(PredefinedSerializer())
    ),
]
...
ApiCompleteAgentExamSubmissionResponse._fields = [
    ...
    FieldMetadata(
        "maxScore", "max_score", "_max_score", int, 0, PredefinedSerializer()
    ),
    FieldMetadata(
        "percentage", "percentage", "_percentage", float, 0.0, PredefinedSerializer()
    ),
    ...
    FieldMetadata(
        "submittedAt", "submitted_at", "_submitted_at", str, "", PredefinedSerializer()
    ),
]
...
ApiCreateAgentExamAgentResponse._fields = [
    FieldMetadata("agentId", "agent_id", "_agent_id", str, "", PredefinedSerializer()),
    FieldMetadata(
        "apiToken", "api_token", "_api_token", str, "", PredefinedSerializer()
    ),
    FieldMetadata(
        "description",
        "description",
