from kagglesdk.education.types.education_service import (
...
class ApiTrackExerciseInteractionRequest(KaggleObject):
    ...
    def __init__(self):
        ...
        self._interaction_type = (
            LearnExerciseInteractionType.LEARN_EXERCISE_INTERACTION_TYPE_UNSPECIFIED
        )
...
ApiTrackExerciseInteractionRequest._fields = [
    ...
    FieldMetadata(
        "learnToolsVersion",
        "learn_tools_version",
        "_learn_tools_version",
        str,
        "",
        PredefinedSerializer(),
    ),
    FieldMetadata(
        "forkParentKernelSessionId",
        "fork_parent_kernel_session_id",
    ...
    FieldMetadata(
        "questionId", "question_id", "_question_id", str, "", PredefinedSerializer()
    ),
    FieldMetadata(
        "questionType",
        "question_type",
...
ApiTrackExerciseInteractionResponse._fields = [
    FieldMetadata(
        "nudge", "nudge", "_nudge", LearnNudge, None, KaggleObjectSerializer()
    ),
    FieldMetadata(
        "showLoginPrompt",
        "show_login_prompt",
