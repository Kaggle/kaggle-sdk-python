...
LearnNudge._fields = [
    FieldMetadata(
        "courseIndex", "course_index", "_course_index", int, 0, PredefinedSerializer()
    ),
    FieldMetadata(
        "courseName", "course_name", "_course_name", str, "", PredefinedSerializer()
    ),
    FieldMetadata(
        "courseSlug", "course_slug", "_course_slug", str, "", PredefinedSerializer()
    ),
    FieldMetadata(
        "nextItemName",
        "next_item_name",
