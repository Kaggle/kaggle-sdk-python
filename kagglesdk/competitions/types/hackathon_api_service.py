...
ApiExportHackathonWriteUpsCsvResponse._fields = [
    FieldMetadata(
        "csvContent", "csv_content", "_csv_content", str, "", PredefinedSerializer()
    ),
]
...
ApiGetHackathonWriteUpRequest._fields = [
    ...
    FieldMetadata(
        "hackathonWriteUpId",
        "hackathon_write_up_id",
        "_hackathon_write_up_id",
        int,
        0,
        PredefinedSerializer(),
    ),
...
ApiListHackathonWriteUpsRequest._fields = [
    ...
    FieldMetadata(
        "skip", "skip", "_skip", int, None, PredefinedSerializer(), optional=True
    ),
    FieldMetadata(
