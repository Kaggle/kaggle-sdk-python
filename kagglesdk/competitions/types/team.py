...
class Team(KaggleObject):
    ...
    def public_leaderboard_submission_id(
        self, public_leaderboard_submission_id: Optional[int]
    ):
    ...
    def public_leaderboard_score_formatted(
        self, public_leaderboard_score_formatted: Optional[str]
    ):
    ...
    def private_leaderboard_submission_id(
        self, private_leaderboard_submission_id: Optional[int]
    ):
    ...
    def private_leaderboard_score_formatted(
        self, private_leaderboard_score_formatted: Optional[str]
    ):
    ...
    def benchmark_model_version_display_name(
        self, benchmark_model_version_display_name: Optional[str]
    ):
        ...
        self._benchmark_model_version_display_name = (
...
Team._fields = [
    ...
    FieldMetadata(
        "teamName", "team_name", "_team_name", str, "", PredefinedSerializer()
    ),
    FieldMetadata(
        "competitionId",
        "competition_id",
    ...
    FieldMetadata(
        ...
        "public_leaderboard_submission_id",
        "_public_leaderboard_submission_id",
        int,
        None,
        PredefinedSerializer(),
        optional=True,
    ...
    FieldMetadata(
        ...
        "public_leaderboard_score_formatted",
        "_public_leaderboard_score_formatted",
        str,
        None,
        PredefinedSerializer(),
        optional=True,
    ...
    FieldMetadata(
        ...
        "private_leaderboard_submission_id",
        "_private_leaderboard_submission_id",
        int,
        None,
        PredefinedSerializer(),
        optional=True,
    ...
    FieldMetadata(
        "privateLeaderboardScoreFormatted",
        "private_leaderboard_score_formatted",
        "_private_leaderboard_score_formatted",
        str,
        None,
        PredefinedSerializer(),
        optional=True,
    ...
    FieldMetadata(
        ...
        "private_leaderboard_rank",
        "_private_leaderboard_rank",
        int,
        None,
        PredefinedSerializer(),
        optional=True,
    ...
    FieldMetadata(
        "benchmarkModelVersionDisplayName",
        "benchmark_model_version_display_name",
        "_benchmark_model_version_display_name",
        str,
        None,
        PredefinedSerializer(),
        optional=True,
...
TeamUpInfo._fields = [
    FieldMetadata(
        "enabled", "enabled", "_enabled", bool, False, PredefinedSerializer()
    ),
    FieldMetadata(
        "teamLeader",
        "team_leader",
    ...
    FieldMetadata(
        "intro", "intro", "_intro", str, None, PredefinedSerializer(), optional=True
    ),
]
