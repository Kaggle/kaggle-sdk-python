...
class CompetitionSettings(KaggleObject):
    ...
    def publicly_cloneable(self) -> "PubliclyCloneable":
        """Indicates if a competition is marked for anyone to clone."""
        return (
            self._publicly_cloneable or PubliclyCloneable.PUBLICLY_CLONEABLE_UNSPECIFIED
        )
    ...
    def prohibit_new_entrants_explicit_deadline(
        self, prohibit_new_entrants_explicit_deadline: datetime
    ):
        ...
        if not isinstance(prohibit_new_entrants_explicit_deadline, datetime):
            raise TypeError(
                "prohibit_new_entrants_explicit_deadline must be of type datetime"
            )
        self._prohibit_new_entrants_explicit_deadline = (
    ...
    def kernels_publishing_disabled_deadline(
        self, kernels_publishing_disabled_deadline: datetime
    ):
        ...
        if not isinstance(kernels_publishing_disabled_deadline, datetime):
            raise TypeError(
                "kernels_publishing_disabled_deadline must be of type datetime"
            )
        self._kernels_publishing_disabled_deadline = (
    ...
    def public_leaderboard_disclaimer_message(
        self, public_leaderboard_disclaimer_message: str
    ):
    ...
    def disable_leaderboard_prize_indicator(
        self, disable_leaderboard_prize_indicator: bool
    ):
    ...
    def withold_final_leaderboard_until_it_has_been_verified(
        self, withold_final_leaderboard_until_it_has_been_verified: bool
    ):
        ...
        if not isinstance(withold_final_leaderboard_until_it_has_been_verified, bool):
            raise TypeError(
                "withold_final_leaderboard_until_it_has_been_verified must be of type bool"
            )
        self._withold_final_leaderboard_until_it_has_been_verified = (
    ...
    def final_leaderboard_has_been_verified(
        self, final_leaderboard_has_been_verified: bool
    ):
    ...
    def final_leaderboard_disclaimer_message(
        self, final_leaderboard_disclaimer_message: str
    ):
...
CompetitionSettings._fields = [
    ...
    FieldMetadata(
        "teamMergerExplicitDeadline",
        "team_merger_explicit_deadline",
        "_team_merger_explicit_deadline",
        datetime,
        None,
        DateTimeSerializer(),
    ),
    FieldMetadata(
        "prohibitNewEntrantsExplicitDeadline",
        "prohibit_new_entrants_explicit_deadline",
        "_prohibit_new_entrants_explicit_deadline",
        datetime,
        None,
        DateTimeSerializer(),
    ),
    FieldMetadata(
        "kernelsPublishingDisabledDeadline",
        "kernels_publishing_disabled_deadline",
        "_kernels_publishing_disabled_deadline",
        datetime,
        None,
        DateTimeSerializer(),
    ),
    ...
    FieldMetadata(
        ...
        "public_leaderboard_disclaimer_message",
        "_public_leaderboard_disclaimer_message",
        str,
        "",
        PredefinedSerializer(),
    ),
    ...
    FieldMetadata(
        "disableLeaderboardPrizeIndicator",
        "disable_leaderboard_prize_indicator",
        "_disable_leaderboard_prize_indicator",
        bool,
        False,
        PredefinedSerializer(),
    ),
    FieldMetadata(
        ...
        "withold_final_leaderboard_until_it_has_been_verified",
        "_withold_final_leaderboard_until_it_has_been_verified",
        bool,
        False,
        PredefinedSerializer(),
    ),
    FieldMetadata(
        ...
        "_final_leaderboard_has_been_verified",
        bool,
        False,
        PredefinedSerializer(),
    ),
    FieldMetadata(
        ...
        "final_leaderboard_disclaimer_message",
        "_final_leaderboard_disclaimer_message",
        str,
        "",
        PredefinedSerializer(),
    ),
    ...
    FieldMetadata(
        "rerunOverrideKernelId",
        "rerun_override_kernel_id",
        "_rerun_override_kernel_id",
        int,
        None,
        PredefinedSerializer(),
        optional=True,
    ...
    FieldMetadata(
        "rerunMaxStaggerMinutes",
        "rerun_max_stagger_minutes",
        "_rerun_max_stagger_minutes",
        float,
        0.0,
        PredefinedSerializer(),
    ),
    FieldMetadata(
        "directlyResponsibleUserId",
        "directly_responsible_user_id",
        "_directly_responsible_user_id",
        int,
        None,
        PredefinedSerializer(),
        optional=True,
