...
from kagglesdk.competitions.types.competition_api_service import (
    ...
    ApiCreateCompetitionSampleSubmissionRequest,
    ...
    ApiListCompetitionHostsResponse,
...
from kagglesdk.datasets.databundles.types.databundle_api_types import (
    ApiDirectoryContent,
    ApiFilesSummary,
)
...
class CompetitionApiClient(object):
    ...
    def list_competitions(
        self, request: ApiListCompetitionsRequest = None
    ) -> ApiListCompetitionsResponse:
        r"""
        Args:
    ...
    def create_competition(
        self, request: ApiCreateCompetitionRequest = None
    ) -> ApiCreateCompetitionResponse:
        r"""
        Args:
    ...
    def list_submissions(
        self, request: ApiListSubmissionsRequest = None
    ) -> ApiListSubmissionsResponse:
        r"""
        Args:
    ...
    def list_team_public_submissions(
        self, request: ApiListTeamPublicSubmissionsRequest = None
    ) -> ApiListTeamPublicSubmissionsResponse:
        r"""
        Args:
        ...
        return self._client.call(
            "competitions.CompetitionApiService",
            "ListTeamPublicSubmissions",
            request,
            ApiListTeamPublicSubmissionsResponse,
        )

    def list_data_files(
        self, request: ApiListDataFilesRequest = None
    ) -> ApiListDataFilesResponse:
        r"""
        Args:
    ...
    def list_data_tree_files(
        self, request: ApiListDataTreeFilesRequest = None
    ) -> ApiDirectoryContent:
        r"""
        Args:
    ...
    def get_leaderboard(
        self, request: ApiGetLeaderboardRequest = None
    ) -> ApiGetLeaderboardResponse:
        r"""
        Args:
    ...
    def download_leaderboard(
        self, request: ApiDownloadLeaderboardRequest = None
    ) -> FileDownload:
        r"""
        Args:
    ...
    def create_submission(
        self, request: ApiCreateSubmissionRequest = None
    ) -> ApiCreateSubmissionResponse:
        r"""
        Args:
    ...
    def create_code_submission(
        self, request: ApiCreateCodeSubmissionRequest = None
    ) -> ApiCreateCodeSubmissionResponse:
        r"""
        Args:
    ...
    def download_data_files(
        self, request: ApiDownloadDataFilesRequest = None
    ) -> HttpRedirect:
        r"""
        Args:
    ...
    def download_data_file(
        self, request: ApiDownloadDataFileRequest = None
    ) -> HttpRedirect:
        r"""
        Args:
    ...
    def get_competition(
        self, request: ApiGetCompetitionRequest = None
    ) -> ApiCompetition:
        r"""
        Args:
    ...
    def get_competition_data_files_summary(
        self, request: ApiGetCompetitionDataFilesSummaryRequest = None
    ) -> ApiFilesSummary:
        r"""
        Args:
        ...
        return self._client.call(
            "competitions.CompetitionApiService",
            "GetCompetitionDataFilesSummary",
            request,
            ApiFilesSummary,
        )

    def list_submission_episodes(
        self, request: ApiListSubmissionEpisodesRequest = None
    ) -> ApiListSubmissionEpisodesResponse:
        r"""
        Args:
        ...
        return self._client.call(
            "competitions.CompetitionApiService",
            "ListSubmissionEpisodes",
            request,
            ApiListSubmissionEpisodesResponse,
        )

    def get_episode_replay(
        self, request: ApiGetEpisodeReplayRequest = None
    ) -> FileDownload:
        r"""
        Args:
    ...
    def get_episode_agent_logs(
        self, request: ApiGetEpisodeAgentLogsRequest = None
    ) -> FileDownload:
        r"""
        Args:
    ...
    def list_competition_pages(
        self, request: ApiListCompetitionPagesRequest = None
    ) -> ApiListCompetitionPagesResponse:
        r"""
        Args:
        ...
        return self._client.call(
            "competitions.CompetitionApiService",
            "ListCompetitionPages",
            request,
            ApiListCompetitionPagesResponse,
        )

    def create_competition_page(
        self, request: ApiCreateCompetitionPageRequest = None
    ) -> ApiCompetitionPage:
        r"""
        Args:
    ...
    def update_competition_page(
        self, request: ApiUpdateCompetitionPageRequest = None
    ) -> ApiCompetitionPage:
        r"""
        Args:
    ...
    def delete_competition_page(self, request: ApiDeleteCompetitionPageRequest = None):
        ...
        self._client.call(
            "competitions.CompetitionApiService", "DeleteCompetitionPage", request, None
        )

    def update_competition_settings(
        self, request: ApiUpdateCompetitionSettingsRequest = None
    ) -> CompetitionSettings:
        r"""
        Args:
    ...
    def get_competition_settings(
        self, request: ApiGetCompetitionSettingsRequest = None
    ) -> CompetitionSettings:
        r"""
        Args:
    ...
    def launch_competition(self, request: ApiLaunchCompetitionRequest = None):
        ...
        self._client.call(
            "competitions.CompetitionApiService", "LaunchCompetition", request, None
        )

    def create_competition_data(
        self, request: ApiCreateCompetitionDataRequest = None
    ) -> ApiCreateCompetitionDataResponse:
        r"""
    ...
    def create_competition_solution(
        self, request: ApiCreateCompetitionSolutionRequest = None
    ):
        r"""
        Not MCP-exported: the prerequisite blob upload step (start_blob_upload +
        signed-URL PUT) has no MCP equivalent, so the tool would be unusable from
    ...
    def get_competition_solution_status(
        self, request: ApiGetCompetitionSolutionStatusRequest = None
    ) -> ApiCompetitionSolutionStatus:
        r"""
        Args:
        ...
        return self._client.call(
            "competitions.CompetitionApiService",
            "GetCompetitionSolutionStatus",
            request,
            ApiCompetitionSolutionStatus,
        )

    def create_competition_sample_submission(
        self, request: ApiCreateCompetitionSampleSubmissionRequest = None
    ):
        r"""
        Not MCP-exported: the prerequisite blob upload step (start_blob_upload +
        signed-URL PUT) has no MCP equivalent, so the tool would be unusable from
        ...
        self._client.call(
            "competitions.CompetitionApiService",
            "CreateCompetitionSampleSubmission",
            request,
            None,
        )

    def list_competition_hosts(
        self, request: ApiListCompetitionHostsRequest = None
    ) -> ApiListCompetitionHostsResponse:
        r"""
        Args:
        ...
        return self._client.call(
            "competitions.CompetitionApiService",
            "ListCompetitionHosts",
            request,
            ApiListCompetitionHostsResponse,
        )

    def list_competition_topics(
        self, request: ApiListCompetitionTopicsRequest = None
    ) -> ApiListCompetitionTopicsResponse:
        r"""
        Args:
    ...
    def list_topic_messages(
        self, request: ApiListTopicMessagesRequest = None
    ) -> ApiListTopicMessagesResponse:
        r"""
        Args:
