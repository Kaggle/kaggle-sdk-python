...
class ParentKernelVersionData(KaggleObject):
  r"""
  Attributes:
    kernel_version_id (int)
    copy_and_edit_url (str)
    title (str)
    view_url (str)
  """
  ...
  @property
  def copy_and_edit_url(self) -> str:
    return self._copy_and_edit_url or ""

  @copy_and_edit_url.setter
  def copy_and_edit_url(self, copy_and_edit_url: Optional[str]):
    if copy_and_edit_url is None:
      del self.copy_and_edit_url
      return
    if not isinstance(copy_and_edit_url, str):
      raise TypeError('copy_and_edit_url must be of type str')
    self._copy_and_edit_url = copy_and_edit_url
  ...
  def view_url(self) -> str:
    return self._view_url or ""

  @view_url.setter
  def view_url(self, view_url: Optional[str]):
    if view_url is None:
      del self.view_url
      return
    if not isinstance(view_url, str):
      raise TypeError('view_url must be of type str')
...
class UpdateKernelDraftResponse(KaggleObject):
  ...
  Attributes:
    sequence (int)
    kernel_version_id (int)
    computed_parent (ParentKernelVersionData)
  ...
  @property
  def computed_parent(self) -> Optional['ParentKernelVersionData']:
    return self._computed_parent or None

  @computed_parent.setter
  def computed_parent(self, computed_parent: Optional[Optional['ParentKernelVersionData']]):
    if computed_parent is None:
      del self.computed_parent
      return
    if not isinstance(computed_parent, ParentKernelVersionData):
      raise TypeError('computed_parent must be of type ParentKernelVersionData')
    self._computed_parent = computed_parent
...
ParentKernelVersionData._fields = [
  FieldMetadata("kernelVersionId", "kernel_version_id", "_kernel_version_id", int, 0, PredefinedSerializer()),
  FieldMetadata("copyAndEditUrl", "copy_and_edit_url", "_copy_and_edit_url", str, None, PredefinedSerializer(), optional=True),
  FieldMetadata("title", "title", "_title", str, None, PredefinedSerializer(), optional=True),
  FieldMetadata("viewUrl", "view_url", "_view_url", str, None, PredefinedSerializer(), optional=True),
]
...
UpdateKernelDraftResponse._fields = [
  FieldMetadata("sequence", "sequence", "_sequence", int, 0, PredefinedSerializer()),
  FieldMetadata("kernelVersionId", "kernel_version_id", "_kernel_version_id", int, 0, PredefinedSerializer()),
  FieldMetadata("computedParent", "computed_parent", "_computed_parent", ParentKernelVersionData, None, KaggleObjectSerializer(), optional=True),
