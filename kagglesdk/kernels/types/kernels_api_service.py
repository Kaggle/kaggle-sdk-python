...
class ApiDownloadKernelOutputRequest(KaggleObject):
    ...
    def endpoint(self):
        if self.file_path:
            path = (
                "/api/v1/kernels/output/download/{owner_slug}/{kernel_slug}/{file_path}"
            )
        else:
...
class ApiSaveKernelRequest(KaggleObject):
    ...
    def kernel_execution_type(self) -> "KernelExecutionType":
        """Which kernel version type to use."""
        return (
            self._kernel_execution_type
            or KernelExecutionType.KERNEL_EXECUTION_TYPE_UNSPECIFIED
        )

    @kernel_execution_type.setter
    def kernel_execution_type(
        self, kernel_execution_type: Optional["KernelExecutionType"]
    ):
...
ApiAcceleratorQuota._fields = [
    FieldMetadata(
        "timeUsed", "time_used", "_time_used", timedelta, None, TimeDeltaSerializer()
    ),
    FieldMetadata(
        "timeReserved",
        "time_reserved",
    ...
    FieldMetadata(
        "minimumTimeAllowed",
        "minimum_time_allowed",
        "_minimum_time_allowed",
        timedelta,
        None,
        TimeDeltaSerializer(),
    ),
    FieldMetadata(
        "isPayToScaleEnabled",
        "is_pay_to_scale_enabled",
        "_is_pay_to_scale_enabled",
        bool,
        False,
...
ApiGetKernelResponse._fields = [
    ...
    FieldMetadata(
        "blob", "blob", "_blob", ApiKernelBlob, None, KaggleObjectSerializer()
    ),
]
...
ApiGetKernelSessionLogsStreamRequest._fields = [
    ...
    FieldMetadata(
        "waitForLogsUrlSeconds",
        "wait_for_logs_url_seconds",
        "_wait_for_logs_url_seconds",
        int,
        None,
        PredefinedSerializer(),
        optional=True,
...
ApiKernelBlob._fields = [
    FieldMetadata(
        "source", "source", "_source", str, None, PredefinedSerializer(), optional=True
    ),
    FieldMetadata(
        "language",
        "language",
...
ApiSaveKernelRequest._fields = [
    ...
    FieldMetadata(
        "kernelExecutionType",
        "kernel_execution_type",
        "_kernel_execution_type",
        KernelExecutionType,
        None,
        EnumSerializer(),
        optional=True,
...
ApiSaveKernelResponse._fields = [
    ...
    FieldMetadata(
        "kernelId", "kernel_id", "_kernel_id", int, 0, PredefinedSerializer()
    ),
]
