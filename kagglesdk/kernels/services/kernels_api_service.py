...
class KernelsApiClient(object):
    ...
    def list_kernels(
        self, request: ApiListKernelsRequest = None
    ) -> ApiListKernelsResponse:
        r"""
        Args:
        ...
        return self._client.call(
            "kernels.KernelsApiService", "ListKernels", request, ApiListKernelsResponse
        )

    def list_kernel_files(
        self, request: ApiListKernelFilesRequest = None
    ) -> ApiListKernelFilesResponse:
        r"""
        Args:
    ...
    def get_kernel(self, request: ApiGetKernelRequest = None) -> ApiGetKernelResponse:
        ...
        return self._client.call(
            "kernels.KernelsApiService", "GetKernel", request, ApiGetKernelResponse
        )

    def save_kernel(
        self, request: ApiSaveKernelRequest = None
    ) -> ApiSaveKernelResponse:
        r"""
        Args:
        ...
        return self._client.call(
            "kernels.KernelsApiService", "SaveKernel", request, ApiSaveKernelResponse
        )
    ...
    def get_kernel_session_status(
        self, request: ApiGetKernelSessionStatusRequest = None
    ) -> ApiGetKernelSessionStatusResponse:
        r"""
        Args:
    ...
    def download_kernel_output(
        self, request: ApiDownloadKernelOutputRequest = None
    ) -> HttpRedirect:
        r"""
        ...
        return self._client.call(
            "kernels.KernelsApiService", "DownloadKernelOutput", request, HttpRedirect
        )

    def download_kernel_output_zip(
        self, request: ApiDownloadKernelOutputZipRequest = None
    ) -> FileDownload:
        r"""
        ...
        return self._client.call(
            "kernels.KernelsApiService",
            "DownloadKernelOutputZip",
            request,
            FileDownload,
        )

    def delete_kernel(
        self, request: ApiDeleteKernelRequest = None
    ) -> ApiDeleteKernelResponse:
        r"""
        Args:
    ...
    def cancel_kernel_session(
        self, request: ApiCancelKernelSessionRequest = None
    ) -> ApiCancelKernelSessionResponse:
        r"""
        Args:
    ...
    def create_kernel_session(
        self, request: ApiCreateKernelSessionRequest = None
    ) -> Operation:
        r"""
        Args:
        ...
        return self._client.call(
            "kernels.KernelsApiService", "CreateKernelSession", request, Operation
        )

    def get_kernel_session_logs_stream(
        self, request: ApiGetKernelSessionLogsStreamRequest = None
    ) -> FileDownload:
        r"""
    ...
    def get_accelerator_quota_statistics(
        self, request: ApiGetAcceleratorQuotaStatisticsRequest = None
    ) -> ApiGetAcceleratorQuotaStatisticsResponse:
        r"""
        Args:
