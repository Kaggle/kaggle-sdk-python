...
class ApiBenchmarkLeaderboard(KaggleObject):
    ...
    class LeaderboardRow(KaggleObject):
        ...
        def task_results(
            self,
        ) -> Optional[List[Optional["ApiBenchmarkLeaderboard.TaskResult"]]]:
        ...
        def task_results(
            ...
            task_results: Optional[
                List[Optional["ApiBenchmarkLeaderboard.TaskResult"]]
            ],
        ):
            ...
            if not all(
                [
                    isinstance(t, ApiBenchmarkLeaderboard.TaskResult)
                    for t in task_results
                ]
            ):
                raise TypeError(
                    "task_results must contain only items of type ApiBenchmarkLeaderboard.TaskResult"
                )
    ...
    def rows(
        self,
    ) -> Optional[List[Optional["ApiBenchmarkLeaderboard.LeaderboardRow"]]]:
        return self._rows

    @rows.setter
    def rows(
        self, rows: Optional[List[Optional["ApiBenchmarkLeaderboard.LeaderboardRow"]]]
    ):
        if rows is None:
            del self.rows
            return
        ...
        if not all(
            [isinstance(t, ApiBenchmarkLeaderboard.LeaderboardRow) for t in rows]
        ):
            raise TypeError(
                "rows must contain only items of type ApiBenchmarkLeaderboard.LeaderboardRow"
            )
        self._rows = rows
...
class ApiListBenchmarkModelsResponse(KaggleObject):
    ...
    def benchmark_models(
        self, benchmark_models: Optional[List[Optional["BenchmarkModel"]]]
    ):
        ...
        if not all([isinstance(t, BenchmarkModel) for t in benchmark_models]):
            raise TypeError(
                "benchmark_models must contain only items of type BenchmarkModel"
            )
...
ApiBenchmarkLeaderboard.LeaderboardRow._fields = [
    ...
    FieldMetadata(
        ...
        "task_results",
        "_task_results",
        ApiBenchmarkLeaderboard.TaskResult,
        [],
...
ApiBenchmarkLeaderboard.TaskResult._fields = [
    ...
    FieldMetadata(
        "benchmarkTaskSlug",
        "benchmark_task_slug",
        "_benchmark_task_slug",
        str,
        "",
        PredefinedSerializer(),
    ),
    FieldMetadata(
        "taskVersion", "task_version", "_task_version", int, 0, PredefinedSerializer()
    ),
    FieldMetadata(
        "result", "result", "_result", BenchmarkResult, None, KaggleObjectSerializer()
    ),
]
...
ApiBenchmarkLeaderboard._fields = [
    FieldMetadata(
        ...
        "rows",
        "_rows",
        ApiBenchmarkLeaderboard.LeaderboardRow,
        [],
        ListSerializer(KaggleObjectSerializer()),
    ),
]
...
ApiListBenchmarkModelsRequest._fields = [
    ...
    FieldMetadata(
        "readMask", "read_mask", "_read_mask", FieldMask, None, FieldMaskSerializer()
    ),
]
