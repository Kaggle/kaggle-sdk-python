...
from kagglesdk.benchmarks.types.benchmark_enums import (
    ...
    BenchmarkTaskVersionSource,
)
from kagglesdk.benchmarks.types.benchmark_task_run_service import (
    BatchScheduleBenchmarkModelVersionResult,
)
...
class ApiBatchScheduleBenchmarkTaskRunsRequest(KaggleObject):
    ...
    def task_slugs(self, task_slugs: Optional[List[Optional["ApiBenchmarkTaskSlug"]]]):
        ...
        if not all([isinstance(t, ApiBenchmarkTaskSlug) for t in task_slugs]):
            raise TypeError(
                "task_slugs must contain only items of type ApiBenchmarkTaskSlug"
            )
...
class ApiBatchScheduleBenchmarkTaskRunsResponse(KaggleObject):
    ...
    def results(
        self,
    ) -> Optional[List[Optional["BatchScheduleBenchmarkModelVersionResult"]]]:
        return self._results

    @results.setter
    def results(
        self,
        results: Optional[List[Optional["BatchScheduleBenchmarkModelVersionResult"]]],
    ):
        if results is None:
            del self.results
            return
        ...
        if not all(
            [isinstance(t, BatchScheduleBenchmarkModelVersionResult) for t in results]
        ):
            raise TypeError(
                "results must contain only items of type BatchScheduleBenchmarkModelVersionResult"
            )
...
class ApiBenchmarkTask(KaggleObject):
    ...
    def __init__(self):
        ...
        self._url = ""
        self._error = None
        self._creation_state = (
            BenchmarkTaskVersionCreationState.BENCHMARK_TASK_VERSION_CREATION_STATE_UNSPECIFIED
        )
        ...
        self._options = None
        self._source = (
            BenchmarkTaskVersionSource.BENCHMARK_TASK_VERSION_SOURCE_UNSPECIFIED
        )
        self._freeze()
    ...
    def creation_state(self, creation_state: "BenchmarkTaskVersionCreationState"):
        ...
        if not isinstance(creation_state, BenchmarkTaskVersionCreationState):
            raise TypeError(
                "creation_state must be of type BenchmarkTaskVersionCreationState"
            )
    ...
    def is_backing_notebook_published(
        self, is_backing_notebook_published: Optional[bool]
    ):
...
class BenchmarkTaskDefinition(KaggleObject):
    ...
    @docker_image.setter
    def docker_image(
        self, docker_image: Optional["BenchmarkTaskDockerImageDefinition"]
    ):
        ...
        if not isinstance(docker_image, BenchmarkTaskDockerImageDefinition):
            raise TypeError(
                "docker_image must be of type BenchmarkTaskDockerImageDefinition"
            )
        del self.notebook
        del self.harbor_git
...
ApiBenchmarkTask._fields = [
    FieldMetadata(
        "slug", "slug", "_slug", ApiBenchmarkTaskSlug, None, KaggleObjectSerializer()
    ),
    ...
    FieldMetadata(
        ...
        "is_backing_notebook_published",
        "_is_backing_notebook_published",
        bool,
        None,
        PredefinedSerializer(),
        optional=True,
...
ApiBenchmarkTaskRun._fields = [
    ...
    FieldMetadata(
        ...
        "_state",
        BenchmarkTaskRunState,
        BenchmarkTaskRunState.BENCHMARK_TASK_RUN_STATE_UNSPECIFIED,
        EnumSerializer(),
    ),
    FieldMetadata(
        "startTime",
...
ApiGetBenchmarkTaskQuotaResponse._fields = [
    ...
    FieldMetadata(
        "totalDailyQuotaAllowed",
        "total_daily_quota_allowed",
        "_total_daily_quota_allowed",
        float,
        0.0,
        PredefinedSerializer(),
    ),
...
ApiPublishBenchmarkTaskRequest._fields = [
    ...
    FieldMetadata(
        "publishBackingNotebook",
        "publish_backing_notebook",
        "_publish_backing_notebook",
        bool,
        False,
        PredefinedSerializer(),
    ),
...
BenchmarkTaskDefinition._fields = [
    FieldMetadata(
        ...
        "notebook",
        "_notebook",
        BenchmarkTaskNotebookDefinition,
        None,
        KaggleObjectSerializer(),
        optional=True,
    ),
    FieldMetadata(
        ...
        "docker_image",
        "_docker_image",
        BenchmarkTaskDockerImageDefinition,
        None,
        KaggleObjectSerializer(),
        optional=True,
    ),
...
BenchmarkTaskGitDefinition._fields = [
    FieldMetadata("url", "url", "_url", str, "", PredefinedSerializer()),
    FieldMetadata(
        "commitHash", "commit_hash", "_commit_hash", str, "", PredefinedSerializer()
    ),
