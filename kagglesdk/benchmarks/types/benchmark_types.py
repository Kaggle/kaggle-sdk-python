...
class BenchmarkModelVersion(KaggleObject):
    ...
    def importance_level(self) -> "BenchmarkModelImportanceLevel":
        """Whether this model version is run on Kaggle-maintained benchmarks"""
        return (
            self._importance_level
            or BenchmarkModelImportanceLevel.BENCHMARK_MODEL_IMPORTANCE_LEVEL_UNSPECIFIED
        )

    @importance_level.setter
    def importance_level(
        self, importance_level: Optional["BenchmarkModelImportanceLevel"]
    ):
        ...
        if not isinstance(importance_level, BenchmarkModelImportanceLevel):
            raise TypeError(
                "importance_level must be of type BenchmarkModelImportanceLevel"
            )
    ...
    def output_modalities(self, output_modalities: Optional[List["Modality"]]):
        ...
        if not all([isinstance(t, Modality) for t in output_modalities]):
            raise TypeError(
                "output_modalities must contain only items of type Modality"
            )
...
class BenchmarkResult(KaggleObject):
    ...
    def custom_additional_results(
        self, custom_additional_results: Optional[List[Optional["CustomResult"]]]
    ):
        ...
        if not all([isinstance(t, CustomResult) for t in custom_additional_results]):
            raise TypeError(
                "custom_additional_results must contain only items of type CustomResult"
            )
    ...
    def numeric_result_private(
        self, numeric_result_private: Optional[Optional["NumericResult"]]
    ):
    ...
    def numeric_result_public(
        self, numeric_result_public: Optional[Optional["NumericResult"]]
    ):
...
class NumericResult(KaggleObject):
    ...
    def uneven_confidence_interval(
        self, uneven_confidence_interval: Optional[Optional["UnevenConfidenceInterval"]]
    ):
        ...
        if not isinstance(uneven_confidence_interval, UnevenConfidenceInterval):
            raise TypeError(
                "uneven_confidence_interval must be of type UnevenConfidenceInterval"
            )
...
BenchmarkModel._fields = [
    ...
    FieldMetadata(
        "displayName", "display_name", "_display_name", str, "", PredefinedSerializer()
    ),
    ...
    FieldMetadata(
        "licenseId", "license_id", "_license_id", int, 0, PredefinedSerializer()
    ),
    FieldMetadata(
        "defaultVersionId",
        "default_version_id",
    ...
    FieldMetadata(
        "license", "license", "_license", License, None, KaggleObjectSerializer()
    ),
    FieldMetadata(
        "published", "published", "_published", bool, False, PredefinedSerializer()
    ),
]
...
BenchmarkModelVersion._fields = [
    ...
    FieldMetadata(
        "isDefault", "is_default", "_is_default", bool, False, PredefinedSerializer()
    ),
    FieldMetadata(
        "published", "published", "_published", bool, False, PredefinedSerializer()
    ),
...
BenchmarkResult._fields = [
    ...
    FieldMetadata(
        ...
        "custom_additional_results",
        "_custom_additional_results",
        CustomResult,
        [],
        ListSerializer(KaggleObjectSerializer()),
    ),
    FieldMetadata(
        "numericResultPrivate",
        "numeric_result_private",
...
NumericResult._fields = [
    ...
    FieldMetadata(
        "unevenConfidenceInterval",
        "uneven_confidence_interval",
        "_uneven_confidence_interval",
        UnevenConfidenceInterval,
        None,
        KaggleObjectSerializer(),
        optional=True,
