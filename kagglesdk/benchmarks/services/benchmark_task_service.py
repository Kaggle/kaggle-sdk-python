...
class BenchmarkTaskClient(object):
  ...
  def get_benchmark_tasks_by_id(self, request: GetBenchmarkTasksByIdRequest = None) -> GetBenchmarkTasksByIdResponse:
    r"""
    Args:
      request (GetBenchmarkTasksByIdRequest):
        The request object; initialized to empty instance if not specified.
    """
    ...
    return self._client.call("benchmarks.BenchmarkTaskService", "GetBenchmarkTasksById", request, GetBenchmarkTasksByIdResponse)
