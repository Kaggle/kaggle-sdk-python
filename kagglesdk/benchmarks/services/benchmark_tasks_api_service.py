from kagglesdk.benchmarks.types.benchmark_tasks_api_service import (
    ...
    ApiGetBenchmarkTaskQuotaResponse,
...
class BenchmarkTasksApiClient(object):
    ...
    def create_benchmark_task(
        self, request: ApiCreateBenchmarkTaskRequest = None
    ) -> ApiBenchmarkTask:
        r"""
        For the given slug:
        ...
        return self._client.call(
            "benchmarks.BenchmarkTasksApiService",
            "CreateBenchmarkTask",
            request,
            ApiBenchmarkTask,
        )

    def batch_schedule_benchmark_task_runs(
        self, request: ApiBatchScheduleBenchmarkTaskRunsRequest = None
    ) -> ApiBatchScheduleBenchmarkTaskRunsResponse:
        r"""
        ...
        return self._client.call(
            "benchmarks.BenchmarkTasksApiService",
            "BatchScheduleBenchmarkTaskRuns",
            request,
            ApiBatchScheduleBenchmarkTaskRunsResponse,
        )

    def list_benchmark_tasks(
        self, request: ApiListBenchmarkTasksRequest = None
    ) -> ApiListBenchmarkTasksResponse:
        r"""
    ...
    def get_benchmark_task(
        self, request: ApiGetBenchmarkTaskRequest = None
    ) -> ApiBenchmarkTask:
        r"""
    ...
    def list_benchmark_task_runs(
        self, request: ApiListBenchmarkTaskRunsRequest = None
    ) -> ApiListBenchmarkTaskRunsResponse:
        r"""
    ...
    def download_benchmark_task_run_output(
        self, request: ApiDownloadBenchmarkTaskRunOutputRequest = None
    ) -> FileDownload:
        r"""
        ...
        return self._client.call(
            "benchmarks.BenchmarkTasksApiService",
            "DownloadBenchmarkTaskRunOutput",
            request,
            FileDownload,
        )

    def get_benchmark_task_run_logs(
        self, request: ApiGetBenchmarkTaskRunLogsRequest = None
    ) -> FileDownload:
        r"""
        ...
        return self._client.call(
            "benchmarks.BenchmarkTasksApiService",
            "GetBenchmarkTaskRunLogs",
            request,
            FileDownload,
        )

    def get_benchmark_task_quota(
        self, request: ApiGetBenchmarkTaskQuotaRequest = None
    ) -> ApiGetBenchmarkTaskQuotaResponse:
        r"""
        ...
        return self._client.call(
            "benchmarks.BenchmarkTasksApiService",
            "GetBenchmarkTaskQuota",
            request,
            ApiGetBenchmarkTaskQuotaResponse,
        )

    def publish_benchmark_task(
        self, request: ApiPublishBenchmarkTaskRequest = None
    ) -> ApiBenchmarkTask:
        r"""
