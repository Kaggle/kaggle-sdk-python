...
class BenchmarkClient(object):
  ...
  def add_task_to_benchmark(self, request: AddTaskToBenchmarkRequest = None):
    r"""
    Args:
      request (AddTaskToBenchmarkRequest):
        The request object; initialized to empty instance if not specified.
    """
    ...
    self._client.call("benchmarks.BenchmarkService", "AddTaskToBenchmark", request, None)
