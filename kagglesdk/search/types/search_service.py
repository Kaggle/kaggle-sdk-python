...
class WriteUpItemInfo(KaggleObject):
    ...
    def competition_info(
        self, competition_info: Optional[Optional["WriteUpCompetitionInfo"]]
    ):
...
WriteUpCompetitionInfo._fields = [
    ...
    FieldMetadata(
        "writeUpLeaderboardRank",
        "write_up_leaderboard_rank",
        "_write_up_leaderboard_rank",
        int,
        None,
        PredefinedSerializer(),
        optional=True,
