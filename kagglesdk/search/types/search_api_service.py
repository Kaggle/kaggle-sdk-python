...
from kagglesdk.competitions.types.search_competitions import (
    SearchCompetitionsOrderBy,
    SearchCompetitionsProfileVisibility,
    SearchCompetitionsRole,
    SearchCompetitionsStatus,
)
...
from kagglesdk.discussions.types.search_discussions import (
    SearchDiscussionsDocumentType,
    SearchDiscussionsOrderBy,
    SearchDiscussionsSourceType,
    SearchDiscussionsTopicType,
...
from kagglesdk.search.types.search_enums import (
    DocumentType,
...
class ApiSearchCompetitionsFilters(KaggleObject):
    ...
    def __init__(self):
        ...
        self._profile_visibility = (
            SearchCompetitionsProfileVisibility.SEARCH_COMPETITIONS_PROFILE_VISIBILITY_ANY
        )
    ...
    def profile_visibility(
        self, profile_visibility: "SearchCompetitionsProfileVisibility"
    ):
        ...
        if not isinstance(profile_visibility, SearchCompetitionsProfileVisibility):
            raise TypeError(
                "profile_visibility must be of type SearchCompetitionsProfileVisibility"
            )
...
class ApiSearchDatasetsDocument(KaggleObject):
    ...
    def file_types(self, file_types: Optional[List["DatasetFileType"]]):
        ...
        if not all([isinstance(t, DatasetFileType) for t in file_types]):
            raise TypeError(
                "file_types must contain only items of type DatasetFileType"
            )
...
class ApiSearchDiscussionsDocument(KaggleObject):
    ...
    def __init__(self):
        ...
        self._source_type = (
            SearchDiscussionsSourceType.SEARCH_DISCUSSIONS_SOURCE_TYPE_UNSPECIFIED
        )
        self._topic_type = (
            SearchDiscussionsTopicType.SEARCH_DISCUSSIONS_TOPIC_TYPE_UNSPECIFIED
        )
        self._type = (
            SearchDiscussionsDocumentType.SEARCH_DISCUSSIONS_DOCUMENT_TYPE_UNSPECIFIED
        )
    ...
    def write_up_metadata(
        self, write_up_metadata: Optional[Optional["WriteUpItemInfo"]]
    ):
...
class ApiSearchDiscussionsFilters(KaggleObject):
    ...
    def __init__(self):
        ...
        self._write_up_inclusion_type = (
            WriteUpInclusionType.WRITE_UP_INCLUSION_TYPE_UNSPECIFIED
        )
    ...
    def write_up_inclusion_type(self, write_up_inclusion_type: "WriteUpInclusionType"):
        ...
        if not isinstance(write_up_inclusion_type, WriteUpInclusionType):
            raise TypeError(
                "write_up_inclusion_type must be of type WriteUpInclusionType"
            )
    ...
    def write_up_types(self, write_up_types: Optional[List["WriteUpType"]]):
        ...
        if not all([isinstance(t, WriteUpType) for t in write_up_types]):
            raise TypeError(
                "write_up_types must contain only items of type WriteUpType"
            )
...
class ApiSearchUsersFilters(KaggleObject):
    ...
    def require_ranking_for_type(self) -> "UserAchievementType":
        """Filter to users that have points for the specified type."""
        return (
            self._require_ranking_for_type
            or UserAchievementType.USER_ACHIEVEMENT_TYPE_UNSPECIFIED
        )

    @require_ranking_for_type.setter
    def require_ranking_for_type(
        self, require_ranking_for_type: Optional["UserAchievementType"]
    ):
        ...
        if not isinstance(require_ranking_for_type, UserAchievementType):
            raise TypeError(
                "require_ranking_for_type must be of type UserAchievementType"
            )
    ...
    def occupation_organization_names(
        self, occupation_organization_names: Optional[List[str]]
    ):
        ...
        if not all([isinstance(t, str) for t in occupation_organization_names]):
            raise TypeError(
                "occupation_organization_names must contain only items of type str"
            )
    ...
    def grandmaster_level(
        self, grandmaster_level: Optional["ListSearchContentRangeFilter"]
    ):
        ...
        if not isinstance(grandmaster_level, ListSearchContentRangeFilter):
            raise TypeError(
                "grandmaster_level must be of type ListSearchContentRangeFilter"
            )
...
class ListEntitiesDocument(KaggleObject):
    ...
    def competition_document(
        self, competition_document: Optional["ApiSearchCompetitionsDocument"]
    ):
        ...
        if not isinstance(competition_document, ApiSearchCompetitionsDocument):
            raise TypeError(
                "competition_document must be of type ApiSearchCompetitionsDocument"
            )
    ...
    def dataset_document(self, dataset_document: Optional["ApiSearchDatasetsDocument"]):
        ...
        if not isinstance(dataset_document, ApiSearchDatasetsDocument):
            raise TypeError(
                "dataset_document must be of type ApiSearchDatasetsDocument"
            )
        del self.competition_document
        del self.kernel_document
        del self.model_document
    ...
    def discussion_document(
        self, discussion_document: Optional["ApiSearchDiscussionsDocument"]
    ):
        ...
        if not isinstance(discussion_document, ApiSearchDiscussionsDocument):
            raise TypeError(
                "discussion_document must be of type ApiSearchDiscussionsDocument"
            )
        del self.competition_document
        del self.dataset_document
        del self.kernel_document
...
class ListEntitiesFilters(KaggleObject):
    ...
    def document_types(self, document_types: Optional[List["DocumentType"]]):
        ...
        if not all([isinstance(t, DocumentType) for t in document_types]):
            raise TypeError(
                "document_types must contain only items of type DocumentType"
            )
    ...
    def competition_filters(
        self, competition_filters: Optional["ApiSearchCompetitionsFilters"]
    ):
        ...
        if not isinstance(competition_filters, ApiSearchCompetitionsFilters):
            raise TypeError(
                "competition_filters must be of type ApiSearchCompetitionsFilters"
            )
    ...
    def discussion_filters(
        self, discussion_filters: Optional["ApiSearchDiscussionsFilters"]
    ):
        ...
        if not isinstance(discussion_filters, ApiSearchDiscussionsFilters):
            raise TypeError(
                "discussion_filters must be of type ApiSearchDiscussionsFilters"
            )
...
class ListEntitiesRequest(KaggleObject):
    ...
    def canonical_order_by(self) -> "ListSearchContentOrderBy":
        ...
        return (
            ...
            or ListSearchContentOrderBy.LIST_SEARCH_CONTENT_ORDER_BY_UNSPECIFIED
        )
    ...
    def canonical_order_by(self, canonical_order_by: "ListSearchContentOrderBy"):
        ...
        if not isinstance(canonical_order_by, ListSearchContentOrderBy):
            raise TypeError(
                "canonical_order_by must be of type ListSearchContentOrderBy"
            )
    ...
    def competitions_order_by(self) -> "SearchCompetitionsOrderBy":
        ...
        return (
            ...
            or SearchCompetitionsOrderBy.SEARCH_COMPETITIONS_ORDER_BY_UNSPECIFIED
        )
    ...
    def competitions_order_by(self, competitions_order_by: "SearchCompetitionsOrderBy"):
        ...
        if not isinstance(competitions_order_by, SearchCompetitionsOrderBy):
            raise TypeError(
                "competitions_order_by must be of type SearchCompetitionsOrderBy"
            )
        del self.canonical_order_by
        del self.datasets_order_by
        del self.kernels_order_by
    ...
    def datasets_order_by(self) -> "SearchDatasetsOrderBy":
        """Datasets order to apply to the results"""
        return (
            self._datasets_order_by
            or SearchDatasetsOrderBy.SEARCH_DATASETS_ORDER_BY_UNSPECIFIED
        )
    ...
    def kernels_order_by(self) -> "SearchKernelsOrderBy":
        ...
        return (
            ...
            or SearchKernelsOrderBy.SEARCH_KERNELS_ORDER_BY_UNSPECIFIED
        )
    ...
    def models_order_by(self) -> "SearchModelsOrderBy":
        """Models order to apply to the results"""
        return (
            self._models_order_by
            or SearchModelsOrderBy.MODELS_SEARCH_ORDER_BY_UNSPECIFIED
        )
    ...
    def discussions_order_by(self) -> "SearchDiscussionsOrderBy":
        """Discussions order to apply to the results"""
        return (
            self._discussions_order_by
            or SearchDiscussionsOrderBy.SEARCH_DISCUSSIONS_ORDER_BY_UNSPECIFIED
        )
    ...
    def discussions_order_by(self, discussions_order_by: "SearchDiscussionsOrderBy"):
        ...
        if not isinstance(discussions_order_by, SearchDiscussionsOrderBy):
            raise TypeError(
                "discussions_order_by must be of type SearchDiscussionsOrderBy"
            )
        del self.canonical_order_by
        del self.competitions_order_by
        del self.datasets_order_by
    ...
    def users_order_by(self) -> "SearchUsersOrderBy":
        """Users order to apply to the results"""
        return (
            self._users_order_by or SearchUsersOrderBy.SEARCH_USERS_ORDER_BY_UNSPECIFIED
        )
...
class ListEntitiesResponse(KaggleObject):
    ...
    def documents(self, documents: Optional[List[Optional["ListEntitiesDocument"]]]):
        ...
        if not all([isinstance(t, ListEntitiesDocument) for t in documents]):
            raise TypeError(
                "documents must contain only items of type ListEntitiesDocument"
            )
...
ApiSearchCompetitionsDocument._fields = [
    FieldMetadata(
        ...
        "_host_segment",
        HostSegment,
        HostSegment.HOST_SEGMENT_UNSPECIFIED,
        EnumSerializer(),
    ),
    FieldMetadata(
        "deadline", "deadline", "_deadline", datetime, None, DateTimeSerializer()
    ),
    FieldMetadata(
        "teamCount", "team_count", "_team_count", int, 0, PredefinedSerializer()
    ),
    FieldMetadata(
        "teamRank",
        "team_rank",
    ...
    FieldMetadata(
        ...
        "_prize_type",
        RewardTypeId,
        RewardTypeId.REWARD_TYPE_ID_UNSPECIFIED,
        EnumSerializer(),
    ),
    FieldMetadata(
        "prizeValue",
    ...
    FieldMetadata(
        "isLaunched", "is_launched", "_is_launched", bool, False, PredefinedSerializer()
    ),
    FieldMetadata(
        "ownerUserHasJoined",
        "owner_user_has_joined",
        "_owner_user_has_joined",
        bool,
        False,
        PredefinedSerializer(),
    ),
    ...
    FieldMetadata(
        ...
        "_only_allow_kernel_submissions",
        bool,
        False,
        PredefinedSerializer(),
    ),
...
ApiSearchCompetitionsFilters._fields = [
    FieldMetadata(
        ...
        "_role",
        SearchCompetitionsRole,
        SearchCompetitionsRole.SEARCH_COMPETITIONS_ROLE_ANY,
        EnumSerializer(),
    ),
    FieldMetadata(
        "status",
        ...
        "_status",
        SearchCompetitionsStatus,
        SearchCompetitionsStatus.SEARCH_COMPETITIONS_STATUS_ANY,
        EnumSerializer(),
    ),
    FieldMetadata(
        "profileVisibility",
...
ApiSearchDatasetsDocument._fields = [
    ...
    FieldMetadata(
        "fileCount", "file_count", "_file_count", int, 0, PredefinedSerializer()
    ),
    FieldMetadata(
        "fileTypes",
        "file_types",
...
ApiSearchDatasetsFilters._fields = [
    ...
    FieldMetadata(
        "size", "size", "_size", DatasetSizeGroup, None, EnumSerializer(), optional=True
    ),
    FieldMetadata(
        "earnedMedal",
        "earned_medal",
...
ApiSearchDiscussionsDocument._fields = [
    ...
    FieldMetadata(
        "forumName", "forum_name", "_forum_name", str, "", PredefinedSerializer()
    ),
    FieldMetadata(
        "forumUrl",
        "forum_url",
...
ApiSearchKernelsDocument._fields = [
    ...
    FieldMetadata(
        "datasourceIsPrivate",
        "datasource_is_private",
        "_datasource_is_private",
        bool,
        False,
        PredefinedSerializer(),
    ),
    ...
    FieldMetadata(
        "isDraft", "is_draft", "_is_draft", bool, False, PredefinedSerializer()
    ),
]
...
ApiSearchUsersDocument._fields = [
    FieldMetadata(
        "grandmasterTierLevel",
        "grandmaster_tier_level",
        "_grandmaster_tier_level",
        int,
        0,
        PredefinedSerializer(),
    ),
    ...
    FieldMetadata(
        "occupationOrganizationName",
        "occupation_organization_name",
        "_occupation_organization_name",
        str,
        None,
        PredefinedSerializer(),
        optional=True,
...
ApiSearchUsersFilters._fields = [
    ...
    FieldMetadata(
        ...
        "require_ranking_for_type",
        "_require_ranking_for_type",
        UserAchievementType,
        None,
        EnumSerializer(),
        optional=True,
    ...
    FieldMetadata(
        ...
        "occupation_organization_names",
        "_occupation_organization_names",
        str,
        [],
        ListSerializer(PredefinedSerializer()),
    ),
...
ListEntitiesDocument._fields = [
    ...
    FieldMetadata(
        "imageUrl", "image_url", "_image_url", str, "", PredefinedSerializer()
    ),
    FieldMetadata(
        "createTime",
        "create_time",
...
ListEntitiesFilters._fields = [
    ...
    FieldMetadata(
        ...
        "_list_type",
        ApiListType,
        ApiListType.API_LIST_TYPE_UNSPECIFIED,
        EnumSerializer(),
    ),
    FieldMetadata(
        "privacy",
