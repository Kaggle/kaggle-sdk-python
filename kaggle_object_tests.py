...
class ListCompetitionsRequestTests(unittest.TestCase):
    ...
    def test_to_dict(self):
        ...
        req.selector.visibility_filter = (
            Selector.VisibilityFilter.VISIBILITY_FILTER_PUBLIC
        )
        ...
        self.assertEqual(
            "LIST_OPTION_USER_ENTERED", json_dict["selector"]["listOption"]
        )
        self.assertEqual("SORT_OPTION_OLDEST", json_dict["selector"]["sortOption"])
        self.assertEqual(
            "VISIBILITY_FILTER_PUBLIC", json_dict["selector"]["visibilityFilter"]
        )
    ...
    def test_to_dict_empty(self):
        ...
        json_dict = ListCompetitionsRequest.to_dict(
            ListCompetitionsRequest(), ignore_defaults=False
        )
    ...
    def test_from_dict(self):
        ...
        self.assertEqual(
            Selector.ListOption.LIST_OPTION_USER_HOSTED, req.selector.list_option
        )
        self.assertEqual(
            Selector.VisibilityFilter.VISIBILITY_FILTER_UNSPECIFIED,
            req.selector.visibility_filter,
...
class GetKernelListDetailsRequestTests(unittest.TestCase):
    ...
    def test_default_values(self):
        ...
        self.assertEqual(
            AccessBehavior.RETURN_SHELL_ENTRY, req.unauthorized_access_behavior
        )
    ...
    def test_to_dict_empty(self):
        ...
        json_dict = GetKernelListDetailsRequest.to_dict(
            GetKernelListDetailsRequest(), ignore_defaults=False
        )
    ...
    def test_from_dict(self):
        ...
        self.assertEqual(
            AccessBehavior.RETURN_NOTHING, req.unauthorized_access_behavior
        )
...
class DataViewerFilterTests(unittest.TestCase):
    ...
    def test_to_dict(self):
        ...
        self.assertIsNone(
            json_dict["andFilter"]["filters"][1]["constantFilter"].get("value")
        )
    ...
    def test_from_dict(self):
        ...
        self.assertEqual(
            "/foo/bar",
            filter.or_filter.filters[1]
            .and_filter.filters[0]
            .column_filter.column.firestore_path,
        )
        self.assertTrue(
            filter.or_filter.filters[1]
            .and_filter.filters[0]
            .column_filter.boolean_filter.value
        )
        self.assertTrue(
            filter.or_filter.filters[1].and_filter.filters[1].constant_filter.value
        )
...
class TimeDeltaSerializerTests(unittest.TestCase):
    ...
    def test_whole_second_duration(self):
        self.assertEqual(
            TimeDeltaSerializer._from_dict_value("0s"), datetime.timedelta(0)
        )
        self.assertEqual(
